...
function applyc(__$ctx, __$ref) {
    ...
    if (__$t === "js") {
        ...
        if (__$t === "calendar") {
            if ($$elem === "cell") {
                return {
                    date: __$ctx.ctx.date
                };
            }
            if (!$$elem) {
                return {
                    date: __$ctx._date,
                    switchers: __$ctx._switchers
                };
            }
        }
        return undefined;
        ...
        var __$t = $$block;
        if (__$t === "calendar") {
            if ($$elem === "content" && (__$ctx.__$a0 & 1) === 0) {
...
[ function(exports, context) {
    ...
    recordExtensions: function(ctx) {
        ctx["_date"] = undefined;
        ctx["_selected"] = undefined;
        ctx["_switchers"] = undefined;
        ctx["__$a0"] = 0;
        ctx["_str"] = undefined;
        ctx["_mode"] = undefined;
        ctx["block"] = undefined;
...
function __$b8(__$ctx, __$ref) {
    var getDaysInMonth__$0 = function(year, mount) {
        return new Date(year, mount + 1, 0).getDate();
    };
    var isDayOfPrevMonth__$1 = function(dayNum, monthStartDay, weekNum) {
        return dayNum < monthStartDay && weekNum === 0;
    };
    var getGrid__$2 = function(date) {
        var grid__$3 = [], selected__$4 = this._selected !== "no";
        var year__$5 = date.getFullYear(), month__$6 = date.getMonth(), day__$7 = date.getDate();
        var daysOnWeek__$8 = 7, daysInMonth__$9 = getDaysInMonth__$0(year__$5, month__$6), weekOnMonth__$10 = Math.ceil(daysInMonth__$9 / daysOnWeek__$8), dayNum__$11 = 1, dayOfWeek__$12 = new Date(year__$5, month__$6, 1).getDay(), monthEnd__$13 = false, weekNum__$14, daysCounter__$15;
        for (weekNum__$14 = 0; weekNum__$14 <= weekOnMonth__$10; weekNum__$14++) {
            var row__$16 = [];
            for (daysCounter__$15 = 1; daysCounter__$15 <= daysOnWeek__$8; daysCounter__$15++) {
                var cellState__$17 = false, val__$18;
                if (isDayOfPrevMonth__$1(daysCounter__$15, dayOfWeek__$12, weekNum__$14)) {
                    val__$18 = new Date(year__$5, month__$6, daysCounter__$15 - dayOfWeek__$12 + 1).getDate();
                    cellState__$17 = "disable";
                } else {
                    if (dayNum__$11 > daysInMonth__$9) {
                        dayNum__$11 = 1;
                        monthEnd__$13 = true;
                    }
                    val__$18 = dayNum__$11++;
                }
                cellState__$17 = cellState__$17 || monthEnd__$13 ? "disable" : "";
                if (selected__$4 && !isDayOfPrevMonth__$1(daysCounter__$15, dayOfWeek__$12, weekNum__$14) && day__$7 === val__$18 && !monthEnd__$13) {
                    cellState__$17 = "active";
                }
                row__$16.push({
                    elem: "cell",
                    content: val__$18,
                    date: new Date(year__$5, month__$6, val__$18),
                    mods: {
                        state: cellState__$17
                    }
                });
            }
            grid__$3.push({
    ...
    return getGrid__$2(__$ctx._date);
}

function __$b10(__$ctx, __$ref) {
    var monthName__$19 = [ "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ];
    var date__$20 = __$ctx._date;
    var title__$21 = monthName__$19[date__$20.getMonth()] + " " + date__$20.getFullYear();
    return title__$21;
}
...
function __$b13(__$ctx, __$ref) {
    ...
    var __$r__$24;
    var __$l0__$25 = __$ctx._date;
    __$ctx._date = ctx__$22.date || new Date();
    var __$l1__$26 = __$ctx._selected;
    __$ctx._selected = ctx__$22.selected || true;
    var __$l2__$27 = __$ctx._switchers;
    __$ctx._switchers = ctx__$22.switchers || [ "prev", "next" ];
    var __$r__$29;
    var __$l3__$30 = __$ctx.__$a0;
    __$ctx.__$a0 = __$ctx.__$a0 | 1;
    __$r__$29 = applyc(__$ctx, __$ref);
    __$ctx.__$a0 = __$l3__$30;
    __$r__$24 = __$r__$29;
    __$ctx._date = __$l0__$25;
    __$ctx._selected = __$l1__$26;
    __$ctx._switchers = __$l2__$27;
    return;
}
...
function __$b14(__$ctx, __$ref) {
    ...
    var __$r__$33;
    var __$l0__$34 = __$ctx._date;
    __$ctx._date = ctx__$31.date || new Date();
    var __$l1__$35 = __$ctx._switchers;
    __$ctx._switchers = ctx__$31.switchers || [ "prev", "next" ];
    var __$r__$37;
    ...
    __$r__$33 = __$r__$37;
    __$ctx._date = __$l0__$34;
    __$ctx._switchers = __$l1__$35;
    return;
}
...
provide(BEMDOM.decl(this.name, /** @lends progressbar.prototype */{
    ...
    setProgress : function(progress) {
        this.params.progress = this._getProgressNum(progress);
        this._setBarWidth(this.params.progress);
    },
    ...
    _setBarWidth : function(progress) {
        var width = progress !== 0? progress + '%' : 0;
        this.elem('bar').css('width', width);
    }
...
/* begin: ../../common.blocks/progressbar/_text/progressbar_text.js */
/**
 * @module progressbar
 */
...
provide(Progressbar.decl({ modName : 'text', modVal : true }, /** @lends progressbar.prototype */{
    ...
    setProgress : function(progress) {
        this.__base.apply(this, arguments);
        this.elem('text').text(this._getProgressNum(progress));
    }
...
/* end: ../../common.blocks/progressbar/_text/progressbar_text.js */
/* begin: ../../common.blocks/cut/cut.js */
/**
 * @module cut
 */
...
/* begin: ../../common.blocks/ymaps/ymaps.js */
/**
 * @module ymmap
...
/* end: ../../common.blocks/ymaps/ymaps.js */
/* begin: ../../common.blocks/ymaps/__config/ymaps__config.js */
/**
...
/* end: ../../common.blocks/ymaps/__config/ymaps__config.js */
/* begin: ../../common.blocks/map/_provider/map_provider_yandex.js */
/**
...
/* end: ../../common.blocks/map/_provider/map_provider_yandex.js */
/* begin: ../../common.blocks/dragndrop/dragndrop.js */
/**
 * @module dragndrop
 */
...
/* end: ../../common.blocks/dragndrop/dragndrop.js */
